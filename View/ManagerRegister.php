    ...
    <div class="col-lg-6">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <select name="provinciaSelect" id="provinciaSelect" class="form-select" onchange="alterMunicipiosAlt()" required>
            ...
            <div class="mb-3">
                ...
                <select name="municipioSelect" onchange="alterComunasAlt()" id="municipioSelect" class="form-select" required>
            ...
            <input type="hidden" name="manager-create" value="1" />
        </form>
    </div>
</div>